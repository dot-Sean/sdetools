...
class PivotalTrackerConnector(AlmConnector):
    ...
    def __init__(self, config, alm_plugin):
        ...
        config.add_custom_option(self.ALM_PROJECT_VERSION, 'Name of release marker to place all new stories under',
                                 default='')
        config.add_custom_option(self.ALM_PRIORITY_MAP, 'Customized map from priority in SDE to PivotalTracker '
    ...
    def pt_get_epic(self, group_name):
        try:
            ...
            raise AlmException('Unable to get epic %s to PivotalTracker because of %s'
                               % (group_name, err))
    ...
    def pt_add_epic(self, group_name):
        """
            Related stories on Pivotal Tracker can be grouped together as an 'Epic'.
